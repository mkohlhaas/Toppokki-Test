...
emailText :: String
emailText = "\n\ngemäß dem Nürnberger Kodex gilt u.a.: \"Die freiwillige Zustimmung der Versuchsperson ist unbedingt erforderlich. Das heißt, dass die betreffende Person im juristischen Sinne fähig sein muss, ihre Einwilligung zu geben; dass sie in der Lage sein muss, unbeeinflusst durch Gewalt, Betrug, List, Druck, Vortäuschung oder irgendeine andere Form der Überredung oder des Zwanges, von ihrem Urteilsvermögen Gebrauch zu machen; dass sie das betreffende Gebiet in seinen Einzelheiten hinreichend kennen und verstehen muss, um eine verständige und informierte Entscheidung treffen zu können. Diese letzte Bedingung macht es notwendig, dass der Versuchsperson vor der Einholung ihrer Zustimmung das Wesen, die Länge und der Zweck des Versuches klargemacht werden; sowie die Methode und die Mittel, welche angewendet werden sollen, alle Unannehmlichkeiten und Gefahren, welche mit Fug zu erwarten sind, und die Folgen für ihre Gesundheit oder ihre Person, welche sich aus der Teilnahme ergeben mögen. Die Pflicht und Verantwortlichkeit, den Wert der Zustimmung festzustellen, obliegt jedem, der den Versuch anordnet, leitet oder ihn durchführt. Dies ist eine persönliche Pflicht und Verantwortlichkeit, welche nicht straflos an andere weitergegeben werden kann.\"\n\nEs gibt in der EU keine vollständig zugelassenen Impfstoffe gegen Covid-19. Maximal gibt es bedingt autorisierte Produkte. Die bedingte Autorisierung von BionTech Pfizer wurde am 3.11.2021, die von Moderna am 4.10.2021 und die von AstraZeneca am 9.11.2021 verlängert.\n\nIch bitte zu bedenken, dass aufgrund dieser Tatsachen und Umstände jeder Parlamentarier, der im Falle von Covid-19 für eine Impfpflicht stimmt, persönlich vor einem internationalen Gericht wegen des äußerst schweren Verschuldens der Gefährdung von Menschenleben strafrechlich verfolgt werden kann.\n\nMit freundlichen Grüßen,\nMichaela Kohlhaas"
...
-- { salutation: "Sehr geehrte Frau Nezahat Baradari,", id: "857121" }
-- { salutation: "Sehr geehrter Herr Thomas Bareiß,", id: "857137" }
-- { salutation: "Sehr geehrter Herr Sören Bartol,", id: "857131" }
-- { salutation: "Sehr geehrter Herr Dr. Dietmar Bartsch,", id: "857153" }
-- { salutation: "Sehr geehrte Frau Bärbel Bas,", id: "857119" }
-- { salutation: "Sehr geehrte Frau Nicole Bauer,", id: "857139" }
-- { salutation: "Sehr geehrte Frau Dr. Christina Baum,", id: "860217" }
-- { salutation: "Sehr geehrter Herr Dr. Bernd Baumann,", id: "857159" }
-- { salutation: "Sehr geehrte Frau Canan Bayram,", id: "857155" }
-- { salutation: "Sehr geehrte Frau Katharina Beck,", id: "860699" }
-- { salutation: "Sehr geehrter Herr Roger Beckamp,", id: "860235" }
-- { salutation: "Sehr geehrter Herr Dr. Holger Becker,", id: "861439" }
-- { salutation: "Sehr geehrter Herr Jens Beeck,", id: "857141" }
-- { salutation: "Sehr geehrter Herr Lukas Benner,", id: "861469" }
-- { salutation: "Sehr geehrter Herr Jürgen Berghahn,", id: "861087" }
-- { salutation: "Sehr geehrter Herr Dr. André Berghegger,", id: "857123" }
-- { salutation: "Sehr geehrter Herr Bengt Bergt,", id: "861373" }
-- { salutation: "Sehr geehrter Herr Marc Bernhard,", id: "857113" }
-- { salutation: "Sehr geehrter Herr Peter Beyer,", id: "857107" }
-- { salutation: "Sehr geehrter Herr Marc Biadacz,", id: "857125" }
-- { salutation: "Sehr geehrter Herr Steffen Bilger,", id: "857145" }
-- { salutation: "Sehr geehrter Herr Matthias W. Birkwald,", id: "857205" }
-- { salutation: "Sehr geehrter Herr Jakob Blankenburg,", id: "860871" }
-- { salutation: "Sehr geehrter Herr Andreas Bleck,", id: "857163" }
-- { salutation: "Sehr geehrter Herr René Bochmann,", id: "860293" }
-- { salutation: "Sehr geehrter Herr Ingo Bodtke,", id: "860299" }
-- { salutation: "Sehr geehrter Herr Peter Boehringer,", id: "857195" }
-- { salutation: "Sehr geehrter Herr Friedhelm Boginski,", id: "860301" }
-- { salutation: "Sehr geehrter Herr Gereon Bollmann,", id: "860309" }
-- { salutation: "Sehr geehrte Frau Simone Borchardt,", id: "860761" }
-- { salutation: "Sehr geehrter Herr Michael Brand,", id: "857183" }
-- { salutation: "Sehr geehrter Herr Dr. Jens Brandenburg,", id: "857215" }
-- { salutation: "Sehr geehrter Herr Mario Brandenburg,", id: "857165" }
-- { salutation: "Sehr geehrter Herr Dirk Brandes,", id: "860313" }
-- { salutation: "Sehr geehrter Herr Dr. Reinhard Brandl,", id: "857193" }
-- { salutation: "Sehr geehrter Herr Stephan Brandner,", id: "857201" }
-- { salutation: "Sehr geehrte Frau Dr. Franziska Brantner,", id: "857199" }
-- { salutation: "Sehr geehrter Herr Prof. Dr. Helge Braun,", id: "857177" }
-- { salutation: "Sehr geehrter Herr Jürgen Braun,", id: "857189" }
-- { salutation: "Sehr geehrte Frau Silvia Breher,", id: "857171" }
-- { salutation: "Sehr geehrter Herr Sebastian Brehm,", id: "857197" }
-- { salutation: "Sehr geehrte Frau Heike Brehmer,", id: "857179" }
-- { salutation: "Sehr geehrter Herr Michael Breilmann,", id: "860953" }
-- { salutation: "Sehr geehrte Frau Leni Breymaier,", id: "857185" }
-- { salutation: "Sehr geehrter Herr Ralph Brinkhaus,", id: "857211" }
-- { salutation: "Sehr geehrter Herr Dr. Carsten Brodesser,", id: "857217" }
-- { salutation: "Sehr geehrter Herr Dr. Marlon Bröhr,", id: "861143" }
-- { salutation: "Sehr geehrte Frau Agnieszka Brugger,", id: "857181" }
-- { salutation: "Sehr geehrter Herr Frank Bsirske,", id: "860817" }
-- { salutation: "Sehr geehrte Frau Sandra Bubendorfer-Licht,", id: "857187" }
-- { salutation: "Sehr geehrte Frau Katrin Budde,", id: "857169" }
-- { salutation: "Sehr geehrter Herr Marcus Bühl,", id: "857207" }
-- { salutation: "Sehr geehrte Frau Clara Bünger,", id: "874465" }
-- { salutation: "Sehr geehrter Herr Yannick Bury,", id: "861565" }
-- { salutation: "Sehr geehrter Herr Dr. Marco Buschmann,", id: "857191" }
-- { salutation: "Sehr geehrter Herr Karlheinz Busen,", id: "857209" }
-- { salutation: "Sehr geehrter Herr Petr Bystron,", id: "857175" }
-- { salutation: "Sehr geehrte Frau Isabel Cademartori,", id: "860203" }
-- { salutation: "Sehr geehrter Herr Prof. Dr. Lars Castellucci,", id: "857235" }
-- { salutation: "Sehr geehrte Frau Dr. Anna Christmann,", id: "857221" }
-- { salutation: "Sehr geehrter Herr Tino Chrupalla,", id: "857229" }
-- { salutation: "Sehr geehrte Frau Gitta Connemann,", id: "857225" }
-- { salutation: "Sehr geehrter Herr Jürgen Coße,", id: "860993" }
-- { salutation: "Sehr geehrte Frau Joana Cotar,", id: "857233" }
-- { salutation: "Sehr geehrter Herr Carl-Julius Cronenberg,", id: "857231" }
-- { salutation: "Sehr geehrter Herr Dr. Gottfried Curio,", id: "857227" }
-- { salutation: "Sehr geehrter Herr Mario Czaja,", id: "861523" }
-- { salutation: "Sehr geehrter Herr Dr. Janosch Dahmen,", id: "857271" }
-- { salutation: "Sehr geehrter Herr Bernhard Daldrup,", id: "857247" }
-- { salutation: "Sehr geehrte Frau Astrid Damerow,", id: "857267" }
-- { salutation: "Sehr geehrte Frau Sevim Dağdelen,", id: "857245" }
-- { salutation: "Sehr geehrte Frau Ekin Deligöz,", id: "857241" }
-- { salutation: "Sehr geehrter Herr Hakan Demir,", id: "861501" }
-- { salutation: "Sehr geehrte Frau Dr. Sandra Detzer,", id: "860129" }
-- { salutation: "Sehr geehrter Herr Dr. Karamba Diaby,", id: "857251" }
-- { salutation: "Sehr geehrter Herr Martin Diedenhofen,", id: "861189" }
-- { salutation: "Sehr geehrter Herr Jan Dieren,", id: "861095" }
-- { salutation: "Sehr geehrter Herr Thomas Dietz,", id: "860429" }
